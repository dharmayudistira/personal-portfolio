  ...
  return (
    <>
      ...
      <main className="relative mx-auto flex w-full max-w-5xl flex-1 flex-col pt-14">
        ...
        <div className="pointer-events-none absolute top-14 right-0 translate-x-full pl-2 font-mono text-[10px] leading-none text-muted-foreground/50 hidden lg:block">
          1024,0
        </div>
        <div className="pointer-events-none absolute bottom-0 left-0 -translate-x-full pr-2 font-mono text-[10px] leading-none text-muted-foreground/50 hidden lg:block">
          0,end
        </div>
        <div className="pointer-events-none absolute bottom-0 right-0 translate-x-full pl-2 font-mono text-[10px] leading-none text-muted-foreground/50 hidden lg:block">
          1024,end
        </div>
